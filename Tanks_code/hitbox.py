...
class Hitbox:
    def __init__(self, x, y, width, height, padding = 0):
        ...
        self.__black_list = [world.CONCRETE, world.WATER, world.BRICK, world.MISSIL, world.PETROL]
    ...
    def __get_corner_points(self):
        ...
        return [p_top_right, p_bottom_left, p_top_left, p_bottom_right]
    ...
    def move(self, dx, dy):
        self.__set_x(dx + self.__set_x())
        self.__set_y(dy + self.__set_y())
